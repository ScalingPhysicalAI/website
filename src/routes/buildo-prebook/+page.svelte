			...
			{:else}
				...
				<div class="rdk-ctas">
					<a
						...
						href="mailto:vipulsaini594@gmail.com?subject=Buildo%20Prebook">Prebook by email</a
					>
				</div>
			{/if}

			<a class="rdk-specs-link" href={resolve('/buildo')}>← Full specifications and features</a>
	...
	<div class="rdk-grid">
		<div class="reveal">
			...
			<p class="section-body">
				America needs its own equivalent of Unitree. Scaling physical AI research in the US requires
				accessible, capable robotic platforms that researchers and developers can actually build on.
...
<section class="rdk-section rdk-closing" id="order">
	<div class="rdk-closing-inner">
		<div class="reveal">
			...
			<p class="section-body">
				Consider a simple pick and place warehouse robot. In the US, the robot AI models can
				generate you $20 per operating hour or $3,200 per month. A warehouse deployed with 20 robots
